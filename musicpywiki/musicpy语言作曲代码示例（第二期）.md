...
### 9.
### 大调中借用lydian调式的和弦进行（附带和声，第二段旋律线）
```python
a = (C('Cmaj7') | C('D7') | C('Fmaj7',3) | C('Cmaj7/-3')) % (1, 1/4) * 4
b_duration = [3/4, 1/8, 1/8, 3/4, 1/8, 1/8, 1/4, 1/4, 1/2, 1/2, 1/2]
b_interval = b_duration
...
## 下一章 [musicpy语言作曲代码示例（第三期）](https://github.com/Rainbow-Dreamer/musicpy/wiki/musicpy%E8%AF%AD%E8%A8%80%E4%BD%9C%E6%9B%B2%E4%BB%A3%E7%A0%81%E7%A4%BA%E4%BE%8B%EF%BC%88%E7%AC%AC%E4%B8%89%E6%9C%9F%EF%BC%89)
